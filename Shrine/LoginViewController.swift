...
class LoginViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    // TODO: Theme the interface with our colors
      ...
      MDCTextFieldColorThemer.applySemanticColorScheme(colorscheme, to: self.usernameTextFieldController)
      MDCTextFieldColorThemer.applySemanticColorScheme(colorscheme, to: self.passwordTextFieldController)
      MDCButtonColorThemer.applySemanticColorScheme(colorscheme, to: self.cancelButton)
      MDCButtonColorThemer.applySemanticColorScheme(colorscheme, to: self.nextButton)
    ...
    // TODO: Theme the interface with our typography
      ...
      MDCTextFieldTypographyThemer.applyTypographyScheme(typographyScheme, to: usernameTextFieldController)
      MDCTextFieldTypographyThemer.applyTypographyScheme(typographyScheme, to: passwordTextFieldController)
      MDCButtonTypographyThemer.applyTypographyScheme(typographyScheme, to: cancelButton)
      MDCButtonTypographyThemer.applyTypographyScheme(typographyScheme, to: nextButton)
  }
